...
CREATE TABLE DIM_CLIENTE (
 ...
 ALTER TABLE DIM_CLIENTE ADD CONSTRAINT PK_CLIENTE PRIMARY KEY (ID_CLIENTE)
-- -----------------------------------------------------
...
CREATE TABLE DIM_TIPO_PAGAMENTO (
 ...
 ALTER TABLE DIM_TIPO_PAGAMENTO ADD CONSTRAINT PK_DIM_TIPO_PAGAMENTO PRIMARY KEY (ID_TIPO_PAGAMENTO)
...
CREATE TABLE DIM_VENDEDORES (
  ...
  ALTER TABLE DIM_VENDEDORES ADD CONSTRAINT PK_DIM_VENDEDORES PRIMARY KEY (ID_VENDEDORES)
...
ALTER TABLE DIM_TRANSPORTE ADD CONSTRAINT PK_DIM_TRANSPORTE PRIMARY KEY (ID_TRANSPORTE)  
-- -----------------------------------------------------
...
ALTER TABLE DIM_PRODUTO ADD CONSTRAINT PK_DIM_PRODUTO PRIMARY KEY (ID_PRODUTO)
...
CREATE TABLE FATO_LOCACAO (
  ...
  ALTER TABLE FATO_LOCACAO ADD CONSTRAINT UQ_FATO_LOCACAO UNIQUE(ID_TEMPO, ID_CLIENTE, ID_TIPO_PAGAMENTO, ID_VENDEDORES, ID_CATEGORIA, ID_TRANSPORTE, ID_PRODUTO, ID_STATUS_PRODUTO)
...
CREATE TABLE FATO_VENDA (
  ...
  --CHAVE PRIMARIA COMPOSTA
  ALTER TABLE FATO_VENDA ADD CONSTRAINT UQ_FATO_VENDA UNIQUE(ID_TEMPO, ID_CLIENTE, ID_CATEGORIA, ID_TIPO_PAGAMENTO, ID_VENDEDORES, ID_TRANSPORTE, ID_PRODUTO)
